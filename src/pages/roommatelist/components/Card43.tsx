...
const FrontDetail = () => {
    ...
    <div className="flex flex-row ml-2 mt-1">
        <div className="font-['700'] text-bold text-2xl ">짜장면님</div>
        <div className="">
      {isStarred ? (
        <Star
    ...
    >
        ...
        >
            <div className="ml-2 text-m text-white font-['700']">
                <h1 className="">학과 : 물리학과 </h1> 
                <h1 className="">학번 : 17학번 </h1> 
                <h1 className="">MBTI : ESFP </h1> 
                <h1 className="">나이 : 비공개 </h1> 
    ...
    >
       <div className="flex flex-col p-2 ml-2 mr-2">
            <div className="flex flex-row ">
                    <div className="font-['700'] text-bold text-3xl ">짜장면님</div>
...
export const Card43 = ({disableFlip=false} : RoomateCardProps) => {
