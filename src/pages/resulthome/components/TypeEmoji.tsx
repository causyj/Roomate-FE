...
export const TypeEmoji = ({animalColor }: IconBoxProps) => {
    return (
        <div>
            <div className="flex flex-row p-2 text-center items-center justify-center gap-1">
